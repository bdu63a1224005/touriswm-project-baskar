	...
	<div class="container">
		...
		<nav class="py-md-4 py-3 d-lg-flex">
			...
			<ul class="menu mt-lg-3 ml-auto">
				<li class="active"><a href="guid_home.php">Home</a></li>
				<li class=""><a href="guid_booking.php">Booking Place</a></li>
...
<section class="team py-5" id="team">
	<div class="container py-md-4">
		<div class="title-desc text-center">
			<h3 class="heading text-capitalize mb-md-5 mb-4">Booking Details</h3>
		</div>
   ...
   $qrys1="select * from  booking_details where guid='$un'";
	 ...
	 ?>
             <tr>
               ...
               <td><a href="guid_booking_1.php?id=<?php echo $row['uname'];?>">Select</a></td>
             </tr>
             <?php
	 }
	 ?>
