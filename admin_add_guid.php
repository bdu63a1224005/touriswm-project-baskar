...
$password=$_REQUEST['password'];
 ...
 $sql = "SELECT id FROM guid_details order by id ASC";
 ...
 $sid=0;
  ...
  while($row = $result->fetch_assoc()) 
  {
   ...
   $qrys1="insert into guid_details values($sid,'$name','$contact','$email','$address','$username','$password','0','0')";
...
<section class="team py-5" id="team">
	<div class="container py-md-4">
		<div class="title-desc text-center">
			<h3 class="heading text-capitalize mb-md-5 mb-4">ADD GUIDE</h3>
		</div>
